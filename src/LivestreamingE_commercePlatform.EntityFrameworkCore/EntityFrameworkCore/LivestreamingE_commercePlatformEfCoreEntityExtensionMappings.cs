...
{
    public static class LivestreamingE_commercePlatformEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE LivestreamingE_commercePlatformModuleExtensionConfigurator CLASS (in the Domain.Shared project)
