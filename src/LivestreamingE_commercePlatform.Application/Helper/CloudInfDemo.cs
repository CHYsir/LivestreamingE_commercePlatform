...
namespace LivestreamingE_commercePlatform.Helper
{
    public class CloudInfDemo
    {
        ...
        //应用 app_key
        private static String APP_KEY = "7scdym0T3U1L0F0RsvcL1PBoHnDRbV0x";
        //应用 app_secret
        private static String APP_SECRET = "AEdOq9w6HaKPOmbKDwFRAc4F3Q6MyZuD5QYxnJGl3aebc6yqEXD62kuWkQ2h1JUs";
